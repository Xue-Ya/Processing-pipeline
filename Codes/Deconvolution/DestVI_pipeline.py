...
# cell2location.models.RegressionModel.setup_anndata(sc_adata, layer="counts", labels_key=celltype_key)
...
# cell2location.models.RegressionModel.setup_anndata(st_adata, layer="counts")
DestVI.setup_anndata(st_adata, layer="counts")

st_model = DestVI.from_rna_model(st_adata, sc_model)
st_model.train(max_epochs=300)
