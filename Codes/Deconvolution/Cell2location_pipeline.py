...
sc_adata = "/home/xuezhengyang/data6/02-deconv_1/Script/Data/SC/res_healthy_sub.h5ad"
st_adata = "/home/xuezhengyang/data6/02-deconv_1/Script/Data/Dataset1/apart/st/st_12_2.h5ad"
celltype_key = "cell_type"
output_path = "/home/xuezhengyang/data6/02-deconv_1/Script/FigureData/Dataset1/st_12_2/Result_Deconv"

adata_snrna_raw = sc.read_h5ad(sc_adata)
adata_vis = sc.read_h5ad(st_adata)

count = adata_snrna_raw.X.todense()

import math
count = np.exp(count) - 1
# data = count / 10000 * total_per_cell
data = count.astype(int) # make integer

adata_snrna_raw.X = csr_matrix(data)
...
# scvi.model.SCVI.setup_anndata(adata=adata_snrna_raw,labels_key=celltype_key)
...
adata_snrna_raw = mod.export_posterior(
    adata_snrna_raw, sample_kwargs={'num_samples': 1000, 'batch_size': 2500, 'use_gpu': False}
)
...
scvi.model.SCVI.setup_anndata(adata=adata_vis)
...
# adata_vis.write("Dataset1/Cell2location_adata_vis_result.h5ad")
adata_vis.obsm['q05_cell_abundance_w_sf'].to_csv(output_path + '/Cell2location_result.csv')
